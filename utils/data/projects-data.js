export const projectsData = [
    {
        ...
        tools: ['Next', 'Typescript', 'Tailwind CSS', 'Express', 'MongoDB', 'Node Mailer'],
    ...
    },
    {
        ...
        tools: ['React', 'NextJS', 'Tailwind CSS', 'Golang', "Google Maps", "NestJS", "TypeScript", "MySQL", "AWS S3", "Sun-Editor", "Gmail Passkey"],
