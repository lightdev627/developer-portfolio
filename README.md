...
export const personalData = {
  ...
  leetcode: "https://leetcode.com/lightdev627/", // Please update if you want to change your LeetCode
  devUsername: "lightdev627", // Please update if you want to change your devUsername
  resume: "#" // Please update if you want to change your resume
}
```
